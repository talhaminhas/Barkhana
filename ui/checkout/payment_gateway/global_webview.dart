...
Future<String> loadHTMLFileAsString(String filePath) async {
...
class _GlobalWebViewState extends State<GlobalWebView> {
  ...
  Future<shelf.Response> _receiveHandler(shelf.Request request) async {
    if (request.method == 'POST') {
      ...
      print(body);
      // Process the JSON data received via POST
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebView(
        initialUrl: 'data:text/html;base64,${base64Encode(const Utf8Encoder().convert(_htmlPage))}',
        ...
        javascriptChannels: Set.from([
          JavascriptChannel(
            ...
            onMessageReceived: (JavascriptMessage message) {
              // Handle JSON response received from JavaScript inside the WebView
              String jsonDataString = message.message;
              Map<String, dynamic> jsonData = jsonDecode(jsonDataString);
              print('Received JSON data from WebView: $jsonData');
            },
          ),
        ]),
      ),
...
<script src="http://62.31.67.208:88/barkhana/vendor/rxp-hpp.js"></script>
 ...
 <style>
    ...
    /* Set the iframe to fill the entire viewport */
    #iframeId {
    position: absolute;
      top: 0;
      left: 0;
		...
		return {
			...
			init: function (idOfEmbeddedButton, idOfTargetIframe, merchantUrl, serverSdkJson) {
				...
				if (window.addEventListener) {
					...
					window.attachEvent('message', internal.receiveMessage);
				}
			}
		};
	})();
...
\$(document).ready(function() {
        ...
        var jsonString = '{"MERCHANT_ID":"dev280779801553211666","ACCOUNT":"internet","ORDER_ID":"NWQ1OWI2ZmEtNzA2YzhhNA","AMOUNT":"1999","CURRENCY":"GBP","TIMESTAMP":"20230724063752","AUTO_SETTLE_FLAG":"1","SHIPPING_CODE":"22|88","SHIPPING_CO":"GB","HPP_SHIPPING_STREET1":"88","HPP_SHIPPING_STREET2":"Norman Road","HPP_SHIPPING_CITY":"Huddersfield","HPP_SHIPPING_STATE":"GB","HPP_SHIPPING_POSTALCODE":"HD2 2UD","HPP_SHIPPING_COUNTRY":"826","BILLING_CODE":"22|88","BILLING_CO":"GB","HPP_BILLING_STREET1":"88","HPP_BILLING_STREET2":"Norman Road","HPP_BILLING_CITY":"Huddersfield","HPP_BILLING_POSTALCODE":"HD2 2UD","HPP_BILLING_COUNTRY":"826","HPP_CUSTOMER_EMAIL":"krishna@itretail.co.uk","HPP_CUSTOMER_PHONENUMBER_MOBILE":"44|07940578109","HPP_ADDRESS_MATCH_INDICATOR":"FALSE","HPP_VERSION":"2","SHA1HASH":"f146080ff56a7bf1f4119c96f83d84aa98e1d7f0"}';


        // Parse the JSON string into a JavaScript object
        var jsonObject = JSON.parse(jsonString);
        RealexHpp.embedded.init("payButtonId", "iframeId", "https://192.168.1.169:8080/", jsonObject );
        \$("#payButtonId").click();
    });
</script>
<body>

<button id="payButtonId" class="btn btn-success">HostPage</button>

    <iframe id="iframeId"  (load)="innitHPP()">
</iframe>
